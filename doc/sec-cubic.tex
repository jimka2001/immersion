...
the two polynomials $\frac{a x^3 + b x^2 + c x + d}{x-r}$, either by doing polynomial long division or using a
more concise technique called synthetic division.

We leave this hand computation as an exercise for the student and simply present the result.
