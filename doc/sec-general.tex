...
\emph{polynomials}.  This section (Section~\ref{sec.general}) explains
the how and why the algorithm works.  The algorithm is summarized
in Section~\ref{sec.algorithm} (page~\pageref{sec.algorithm})

If you want to start coding quickly, you skip directly to
Section~\ref{sec.line} (page~\pageref{sec.line}).  If you are also
