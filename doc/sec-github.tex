...
\item Reopen the explorer: \includegraphics[width=7cm]{explorer2.png}, and select the \code{src/hello.py} file.
...
To run the tests, press the \includegraphics[width=1cm]{run-triangle.png} which
