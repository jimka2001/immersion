...
def quadratic_roots_from_coefficients(a, b, c):
    epsilon = 0.00001
...
def cubic_roots_from_coefficients(a, b, c, d):
    ...
    """
    if a < 0:
        return cubic_roots_from_coefficients(-a, -b, -c, -d)
    ...
    B = b + A * r1
    C = c + B * r1
    r2r3 = quadratic_roots_from_coefficients(A, B, C)
    if r2r3:
        r2, r3 = r2r3
        return [r1, r2, r3]
    else:
